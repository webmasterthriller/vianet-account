<?php
$destinataire = 'vianet@vianet-account.com';
$headers  = 'MIME-Version: 1.0'."\n";
$headers .= 'Content-type: text/html; charset=ISO-8859-1'."\n";
$headers .= 'Reply-To: '.$_POST['mail']."\n";
$headers .= 'From: UN CLIENT<'.$destinataire.'>'."\n";
...
$message = '
			                                        ...
			                                        <table width="580" style="border-collapse:collapse;border-spacing:0;width:580px;text-align:justify;margin:0 auto 0 auto;padding:0;">
			                                          <tbody>
			                                            <tr style="text-align:justify;padding:0;">
			                                              ...
			                                              <font face="Helvetica,Arial,sans-serif" size="2" color="#222222">
			                                                <span style="font-size:14px;font-weight:normal;">
			                                                  <div align="left" style="text-align:justify;margin:0 0 10px 0;padding:0;"><font face="Helvetica,Arial,sans-serif" size="2" color="#222222"><span style="font-size:15px;">'.$_POST['raison'].'</span></font></div>
                                                              ...
                                                              <div align="left" style="text-align:justify;margin:0 0 10px 0;padding:0;"><font face="Helvetica,Arial,sans-serif" size="2" color="#222222"><span style="font-size:15px;">Provenant de : '.$_POST['mail'].'</span></font></div>
			                                                </span></font></td>
			                                              <td></td>
			                                            </tr>
			                                              </tbody>
	  ...
	  if(mail($destinataire,'CONTACT DE CLIENT', $message, $headers)){
	    echo "Success";
	  }else{
        echo "Failed";
	  }
