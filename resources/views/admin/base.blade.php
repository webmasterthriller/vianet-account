  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav  bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <div class="sidebar-heading">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-gradient-light py-2 collapse-inner rounded">
                    <a class="collapse-item" href="/garant/new">
                        <i class="fas fa-fw fa-money-check-alt"></i>
                        <span>{{__("New garant")}}</span>
                        <i class="fas fa-fw fa-plus-circle"></i>
                    </a>

                    <a class="collapse-item" href="/operation">
                        <i class="fas fa-fw fa-wallet"></i>
                        <span>{{__("Operation")}}</span>
                    </a>

                    <a class="collapse-item" href="/operation/new">
        ...
        <hr class="sidebar-divider">
        <!-- Heading -->
      <div class="sidebar-heading">{{__("Parameters")}}</div>
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item no-arrow mx-1">
                        <a class="nav-link active" href="/admin">{{__("Dashboard")}}</a>
                    </li>
                    <li class="nav-item no-arrow mx-1">
                        <a class="nav-link" href="/garants">{{__("Garant")}}</a>
                    </li>
                    <li class="nav-item no-arrow mx-1">
                        <a class="nav-link" href="/operation">{{__("Operation")}}</a>
                    </li>
