...
@section('base-content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="/garant/messenger/new" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-envelope fa-sm text-white-50"></i> New Message</a>
        </div>
                ...
                <tr>
                    ...
                    <div class="row">
                        <div class="card shadow col-lg mb-lg-4">
                            <a href="/garant/messenger/read/0001" class="btn">
                                <div class="card-body">
