...
@section('base-content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="/garant/messenger" class="d-none d-sm-inline-block btn btn-sm btn-outline-dark shadow-sm"> Cancel</a>
        </div>
                    ...
                    <form class="message-form">
                        <fieldset>
                            ...
                            <div class="form-group row">
                                <label for="subject" class="col-sm-2 col-form-label">recipient</label>
                                <div class="col-sm-10">
